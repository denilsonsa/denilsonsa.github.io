...
<!-- more -->This month I bought a [Sony Ericsson](http://www.sonyericsson.com/) K750i phone (I would post a direct link to K750i phone, but that site is too bad and with too ugly URLs that might stop working anytime). It is a very good phone, with the following features:
...
* Camera light (not exactly a camera "flash"), which can also be used as a flash light, or as SOS light
...
* Sound recorder (allows you to record your voice, for quick memos)
...
I don't like the idea of 5-way joystick/navigation button in general. I think it is too easy to accidentally move the joystick to sides, while trying to press it in middle. It is too easy that it happens lots of times. I guess my mom won't like that too, whenever she needs/wants to use this phone.

Unfortunetaly, most phones have this (that Nokia 3100 didn't have), and we have to get used to it. Fortunately, the K750i joystick is a lot better than Nokia 3100 4-way navigation key.
...
1. Only the contact name is shown, and the left softkey is "Details", which show all fields. If the value is too big for screen (and is cropped), you can always use Options (left softkey) → View (4th item).
...
Because phone identifies itself as having many USB interfaces (to act as a modem, as a mass storage device, and as a serial device), Windows asks to install drivers. This way, I can't use my phone with 2GB Memory Stick as a pen-drive.

In fact, this is not a problem with this phone, but a problem with Windows. I can use it as a pen-drive with no problems at Gnu/Linux.
...
The (big) font used for numbers is ugly, confusing, and hard to read.
...
This is not true. A "real" camera has many more options to change how the photo will be taken (sensibility, shutter speed,…). Also, a "real" camera has "Carl Zeiss" lenses (whatever that means :D ) or at least some "glass" lens. The phone camera has plastic lens.
...
To be fair, I don't think these things are so bad in a cell phone. It is a phone, and not a camera, after all. It is just nice to have a good (tough not as good as a dedicated one) camera at hand.
...
This phone can also act as a flash light, in those blackout days or dark places. Of course, very useful to have one at hand.
...
* [Sony Ericsson K750i at FoneWiki](http://fonewiki.org/index.php?title=Sony_Ericsson_K750i)
* [Sony Ericsson K750i at Esato](http://www.esato.com/phones/index.php/phone=168)
* [FPC Bench test results](http://www.dpsoftware.org/result/sony/k750.html)
